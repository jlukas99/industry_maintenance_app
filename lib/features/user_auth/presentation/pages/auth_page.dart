        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  authState.maybeWhen(initial: () => 'Logowanie', orElse: () => 'Rejestracja'),
                ...
                CupertinoButton(
                  color: Colors.black,
                  onPressed: () async {
                    await authState.maybeWhen(initial: () => authCubit.loginUser('dd', 'bb'), orElse: () {});
                  },
                  child: Text(
                    authState.maybeWhen(initial: () => 'Zaloguj', isAuthPage: () => 'Zarejestruj', orElse: () => ''),
                  ),
                ),
              ],
            ),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  authState.maybeWhen(
                      initial: () => 'Nie masz konta', isAuthPage: () => 'Masz już konto', orElse: () => '',),
                ),
                const SizedBox(
                  width: 20.0,
                ),
                InkWell(
                  child: Text(
                    authState.maybeWhen(
                        initial: () => 'Zarejestruj się', isAuthPage: () => 'Zaloguj się', orElse: () => '',),
